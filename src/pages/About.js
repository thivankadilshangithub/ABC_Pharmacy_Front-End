      ...
      <div class="row mt-10" style={{ height: "100vh" }}>
        <div class="col-6 leftabout">
          ...
          <p className="contentabout">
            Welcome to ABC Pharmacy, your trusted partner in health. We're
            dedicated to providing high-quality pharmaceutical services and
            personalized care. Whether you need prescriptions or wellness
            advice, our experienced team is here for you. Your health is our
            priority.
          </p>
          <div className="row">
            <div className="col">
